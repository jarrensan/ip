...
public class UiTest {
    ...
    public String showMarkTask(TaskTest task) {
        return h_line + "Nice! I've marked this task as done: \n" + task + h_line;
    }

    public String showUnmarkTask(TaskTest task) {
        return h_line + "OK, I've marked this task as not done yet: \n" + task + h_line;
    }

    public String showAddTask(TaskTest task, int task_size) {
        return h_line +
    ...
    public String showList(TaskListTest taskList) {
        if (taskList.isEmpty()) {
    ...
    public String showDeleteTask(TaskTest task, int task_size) {
        return h_line +
